...
module.exports = {
    win32: {
        ...
        files: { // First file must be the executable
            ...
            '>=0.13.0-beta.1 <0.14.1': ['nw.exe', 'icudtl.dat', 'libEGL.dll', 'libGLESv2.dll', 'ffmpeg.dll', 'locales', 'd3dcompiler_47.dll', 'dbghelp.dll','natives_blob.bin','node.dll','nw.dll','nw_100_percent.pak','nw_200_percent.pak','nw_elf.dll','resources.pak','snapshot_blob.bin'],
            '>=0.14.1': ['nw.exe', 'icudtl.dat', 'libexif.dll', 'libEGL.dll', 'libGLESv2.dll', 'ffmpeg.dll', 'locales', 'd3dcompiler_47.dll', 'dbghelp.dll','natives_blob.bin','node.dll','nw.dll','nw_100_percent.pak','nw_200_percent.pak','nw_elf.dll','resources.pak','snapshot_blob.bin']
        },
    ...
    win64: {
        ...
        files: { // First file must be the executable
            ...
            '>0.9.2 <0.12.0': ['nw.exe', 'ffmpegsumo.dll', 'icudtl.dat', 'libEGL.dll', 'libGLESv2.dll', 'nw.pak', 'locales'],
            '>=0.12.0 <0.13.0-beta.1': ['nw.exe', 'ffmpegsumo.dll', 'icudtl.dat', 'libEGL.dll', 'libGLESv2.dll', 'nw.pak', 'locales', 'd3dcompiler_47.dll', 'pdf.dll'],
            '>=0.13.0-beta.1 <0.14.1': ['nw.exe', 'icudtl.dat', 'libEGL.dll', 'ffmpeg.dll', 'libGLESv2.dll', 'locales', 'd3dcompiler_47.dll', 'dbghelp.dll','natives_blob.bin','node.dll','nw.dll','nw_100_percent.pak','nw_200_percent.pak','nw_elf.dll','resources.pak','snapshot_blob.bin'],
            '>=0.14.1': ['nw.exe', 'icudtl.dat', 'libexif.dll', 'libEGL.dll', 'libGLESv2.dll', 'ffmpeg.dll', 'locales', 'd3dcompiler_47.dll', 'dbghelp.dll','natives_blob.bin','node.dll','nw.dll','nw_100_percent.pak','nw_200_percent.pak','nw_elf.dll','resources.pak','snapshot_blob.bin']
        },
